...
public class LootGenerator implements RandomGenerator<Item> {
    ...
    public Item single(Random rng){
        ...
        int price = Integer.parseInt(parsedLine.get(4));
        ...
        {
            case "HealingPotion":
                return new HealingPotion(nameVal, propertyVal, weightVal, price);
                
            case "ManaPotion":
                return new ManaPotion(nameVal, propertyVal, weightVal, price);
