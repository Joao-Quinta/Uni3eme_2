...
public class Game {
    ...
    public static void main(String[] args){
        ...
        */
        ...
        int nbManaPotions = 1;
        ItemInventory selectedHealingPotions = new ItemInventory<Item>(healingPotID, new HealingPotion(viewedInvFromVendor.getItemInventoryByID(healingPotID).getT().getName(), ((HealingPotion) viewedInvFromVendor.getItemInventoryByID(healingPotID).getT()).getPotionValue(), viewedInvFromVendor.getItemInventoryByID(healingPotID).getT().getWeight(), viewedInvFromVendor.getItemInventoryByID(healingPotID).getT().getPrice()), nbHealingPotions);//viewedInvFromVendor.getItemInventoryByID(healingPotID);
        //selectedHealingPotions.setAmmount(3);//client veut acheter 3 potions de vie
        ItemInventory selectedManaPotions = new ItemInventory<Item>(manaPotID, new ManaPotion(viewedInvFromVendor.getItemInventoryByID(manaPotID).getT().getName(), ((ManaPotion) viewedInvFromVendor.getItemInventoryByID(manaPotID).getT()).getPotionValue(), viewedInvFromVendor.getItemInventoryByID(manaPotID).getT().getWeight(), viewedInvFromVendor.getItemInventoryByID(manaPotID).getT().getPrice()), nbManaPotions);
        //selectedManaPotions.setAmmount(1);//veut acheter 1 pot de mana
        ...
        ItemInventory selectedHealingPotions2 = new ItemInventory<Item>(healingPotID, new HealingPotion(Boromir.showBagContents().getItemInventoryByID(healingPotID).getT().getName(), ((HealingPotion) Boromir.showBagContents().getItemInventoryByID(healingPotID).getT()).getPotionValue(), Boromir.showBagContents().getItemInventoryByID(healingPotID).getT().getWeight(), Boromir.showBagContents().getItemInventoryByID(healingPotID).getT().getPrice()), nbHealingPotions2);
        ItemInventory selectedManaPotions2 = new ItemInventory<Item>(manaPotID, new ManaPotion(Boromir.showBagContents().getItemInventoryByID(manaPotID).getT().getName(), ((ManaPotion) Boromir.showBagContents().getItemInventoryByID(manaPotID).getT()).getPotionValue(), Boromir.showBagContents().getItemInventoryByID(manaPotID).getT().getWeight(), Boromir.showBagContents().getItemInventoryByID(manaPotID).getT().getPrice()), nbManaPotions2);
